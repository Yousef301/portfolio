        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-20">
          ...
          >
            ...
            >
              ...
              >
                <iframe
                  src="https://player.vimeo.com/video/1077320121"
                  frameBorder="0"
                  allowFullScreen
                ...
                {[
                  {
                    ...
                    demo: (
                      <div className="relative aspect-video rounded-xl overflow-hidden mt-4">
                        <iframe
                          src="https://player.vimeo.com/video/1077320160"
                          frameBorder="0"
                          width="100%"
                          height="100%"
                          allowFullScreen
                  ...
                  },
                  {
                    ...
                    demo: (
                      <div className="relative aspect-video rounded-xl overflow-hidden mt-4">
                        <iframe
                          src="https://player.vimeo.com/video/1077320099"
                          frameBorder="0"
                          width="100%"
                          height="100%"
                          allowFullScreen
                  ...
                  },
                  {
                    ...
                    demo: (
                      <div className="relative rounded-xl overflow-hidden mt-4 aspect-video">
                        <iframe
                          src="https://player.vimeo.com/video/1077320059"
                          width="1280"
                          height="720"
                          frameBorder="0"
                          allowFullScreen
                  ...
                  },
                  {
                    ...
                    demo: (
                      <div className="relative aspect-video rounded-xl overflow-hidden mt-4">
                        <iframe
                          src="https://player.vimeo.com/video/1077320077"
                          frameBorder="0"
                          width="100%"
                          height="100%"
                          allowFullScreen
                  ...
                  },
                  {
                    ...
                    demo: (
                      <div className="relative aspect-video rounded-xl overflow-hidden mt-4">
                        <iframe
                          src="https://player.vimeo.com/video/1077320190"
                          frameBorder="0"
                          width="100%"
                          height="100%"
                          allowFullScreen
